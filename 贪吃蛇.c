...
void get_dir(void)
{
	...
	{
		n = getch();
		if(n == 'w' && direction != 's') direction = 'w';
		else if(n == 'a'&& direction != 'd') direction = 'a';
		else if(n == 's'&& direction != 'w') direction = 's';
		else if(n == 'd'&& direction != 'a') direction = 'd';
		else return;
	}
	return;
}
